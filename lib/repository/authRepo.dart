...
class AuthenticationRepository{
  ...
  Future<void> addUser({required String email,required String name,required String password})async{
    ...
    if(res)
      Utils.toast("User Added back to repo", Colors.green);
    else
      Utils.toast("User Not Added back to repo", Colors.red);
  }
  ...
  Future<void> deleteById(String email) async {
    ...
    if(res)
      Utils.toast("User Deleted back to repo", Colors.green);
    else
      Utils.toast("User Not Deleted back to repo", Colors.red);
  }
